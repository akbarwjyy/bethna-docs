...
{% hint style="warning" %}
**Beware of Scams**: Always verify URLs. BethNa will never DM you first or ask for your seed phrase.
{% endhint %}
...
**Stay Safe**: Bookmark the official URL and always check the SSL certificate.
